...
const file_common_collection_proto_rawDesc = "" +
	"\n" +
	"\x17common/collection.proto\x12\x06common\x1a\x15common/policies.proto\"O\n" +
	"\x17CollectionConfigPackage\x120\n" +
	"\x06config\x18\x01 \x03(\v2\x18.common.CollectionConfigR\x06config:\x02\x18\x01\"}\n" +
	"\x10CollectionConfig\x12Z\n" +
	"\x18static_collection_config\x18\x01 \x01(\v2\x1e.common.StaticCollectionConfigH\x00R\x16staticCollectionConfig:\x02\x18\x01B\t\n" +
	"\apayload\"\xa0\x03\n" +
	"\x16StaticCollectionConfig\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12L\n" +
	"\x12member_orgs_policy\x18\x02 \x01(\v2\x1e.common.CollectionPolicyConfigR\x10memberOrgsPolicy\x12.\n" +
	...
	"\x12endorsement_policy\x18\b \x01(\v2\x19.common.ApplicationPolicyR\x11endorsementPolicy:\x02\x18\x01\"u\n" +
	"\x16CollectionPolicyConfig\x12L\n" +
	"\x10signature_policy\x18\x01 \x01(\v2\x1f.common.SignaturePolicyEnvelopeH\x00R\x0fsignaturePolicy:\x02\x18\x01B\t\n" +
	"\apayloadBV\n" +
...
var (
	...
	file_common_collection_proto_rawDescData []byte
)

func file_common_collection_proto_rawDescGZIP() []byte {
	file_common_collection_proto_rawDescOnce.Do(func() {
		file_common_collection_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_collection_proto_rawDesc), len(file_common_collection_proto_rawDesc)))
	})
...
func file_common_collection_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_collection_proto_rawDesc), len(file_common_collection_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
