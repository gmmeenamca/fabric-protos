...
const file_common_common_proto_rawDesc = "" +
	...
	"\n" +
	"signatures\x18\x02 \x03(\v2\x19.common.MetadataSignatureR\n" +
	"signatures\"\x89\x01\n" +
	"\x11MetadataSignature\x12)\n" +
	"\x10signature_header\x18\x01 \x01(\fR\x0fsignatureHeader\x12\x1c\n" +
	"\tsignature\x18\x02 \x01(\fR\tsignature\x12+\n" +
	"\x11identifier_header\x18\x03 \x01(\fR\x10identifierHeader\"H\n" +
	"\x10IdentifierHeader\x12\x1e\n" +
	"\n" +
	"identifier\x18\x01 \x01(\rR\n" +
	"identifier\x12\x14\n" +
	"\x05nonce\x18\x02 \x01(\fR\x05nonce\"Z\n" +
	"\x06Header\x12%\n" +
	"\x0echannel_header\x18\x01 \x01(\fR\rchannelHeader\x12)\n" +
	"\x10signature_header\x18\x02 \x01(\fR\x0fsignatureHeader\"\x83\x02\n" +
	...
	"\n" +
	"channel_id\x18\x04 \x01(\tR\tchannelId\x12\x13\n" +
	"\x05tx_id\x18\x05 \x01(\tR\x04txId\x12\x14\n" +
	"\x05epoch\x18\x06 \x01(\x04R\x05epoch\x12\x1c\n" +
	"\textension\x18\a \x01(\fR\textension\x12\"\n" +
	"\rtls_cert_hash\x18\b \x01(\fR\vtlsCertHash\"A\n" +
	"\x0fSignatureHeader\x12\x18\n" +
	"\acreator\x18\x01 \x01(\fR\acreator\x12\x14\n" +
	"\x05nonce\x18\x02 \x01(\fR\x05nonce\"E\n" +
	"\aPayload\x12&\n" +
	...
	"\bmetadata\x18\x03 \x01(\v2\x15.common.BlockMetadataR\bmetadata\"g\n" +
	...
	"\bmetadata\x18\x01 \x03(\fR\bmetadata\"z\n" +
	"\x14OrdererBlockMetadata\x123\n" +
	"\vlast_config\x18\x01 \x01(\v2\x12.common.LastConfigR\n" +
	"lastConfig\x12-\n" +
	"\x12consenter_metadata\x18\x02 \x01(\fR\x11consenterMetadata*\xc0\x01\n" +
	"\x06Status\x12\v\n" +
	...
	"\n" +
	"\x06CONFIG\x10\x01\x12\x11\n" +
	"\rCONFIG_UPDATE\x10\x02\x12\x18\n" +
	"\x14ENDORSER_TRANSACTION\x10\x03\x12\x1b\n" +
	"\x13ORDERER_TRANSACTION\x10\x04\x1a\x02\b\x01\x12\x15\n" +
	"\x11DELIVER_SEEK_INFO\x10\x05\x12\x15\n" +
	"\x11CHAINCODE_PACKAGE\x10\x06\"\x04\b\a\x10\a\"\x04\b\b\x10\b\"\x04\b\t\x10\t*\x14PEER_RESOURCE_UPDATE*\x14PEER_ADMIN_OPERATION*\x11TOKEN_TRANSACTION*t\n" +
	"\x12BlockMetadataIndex\x12\x0e\n" +
	"\n" +
	"SIGNATURES\x10\x00\x12\x13\n" +
	"\vLAST_CONFIG\x10\x01\x1a\x02\b\x01\x12\x17\n" +
	"\x13TRANSACTIONS_FILTER\x10\x02\x12\x0f\n" +
	"\aORDERER\x10\x03\x1a\x02\b\x01\x12\x0f\n" +
	"\vCOMMIT_HASH\x10\x04BV\n" +
